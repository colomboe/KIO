...
inline fun <R1, E1, A1, R2 : R1, E2 : E1, A2, B> parMapN(a: KIO<R1, E1, A1>, b: KIO<R2, E2, A2>, crossinline f: (A1, A2) -> B): KIO<R2, E1, B> =
        a.fork()                  to  { fa ->
        b.fork()                  to  { fb ->
...
@Suppress("UNCHECKED_CAST")
inline fun <R1, E1, A1, R2 : R1, E2 : E1, A2, R3 : R2, E3 : E2, A3, B> parMapN(
                                         a: KIO<R1, E1, A1>,
                                         b: KIO<R2, E2, A2>,
                                         c: KIO<R3, E3, A3>,
                                         crossinline f: (A1, A2, A3) -> B): KIO<R3, E1, B> {
